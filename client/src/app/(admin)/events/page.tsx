...
export default function EventsPage() {
  const { events, setEvents, isLoading, setLoading, setError } = useEventStore();
  ...
  }, [page, debouncedSearch, statusFilter, setEvents, setLoading, setError]);
  ...
  return (
    <div className="flex flex-col flex-1">
      <Header
        title="Events"
        subtitle="Manage all event bookings and assignments"
      />
